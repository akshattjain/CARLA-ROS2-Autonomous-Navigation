...
2.  Basic software packages required in the root for whole project, Open a new terminal and install them with below commands.
...
5.  **CARLA 0.9.15.0 simulator** installed.
